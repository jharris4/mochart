...
describe('createCandlestick', () => {
  ...
  it('spans wicks from low to high and bodies from open to close, split by direction', () => {
    ...
    expect(upWick).toMatchObject({ property: 'upHigh', rangeProperty: 'low', barWidthPercent: 0.15, showInLegend: false, valueLabel: 'Range' });
    expect(downWick).toMatchObject({ property: 'downHigh', rangeProperty: 'low', barWidthPercent: 0.15, showInLegend: false, valueLabel: 'Range' });
