...
export default class AnimatedChart extends PureComponent {
  static defaultProps = {
    standalone: true,
  ...
  render() {
    ...
    return (
      <Chart mochartConfig={mochartConfig} dataProvider={dataProvider} loading={loading} error={error} chartData={chartData} standalone={standalone}
             style={style} width={width} height={height} focusData={focusData} onFocus={this.onFocus} onSeriesFilter={onSeriesFilter}
