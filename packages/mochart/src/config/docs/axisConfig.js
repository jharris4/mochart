export default function getDescriptions() {
  return {
    ...
    axisLineColor: 'the color of the line shown along the axis',
    axisLineFocusedColor: 'the color of the line shown along the focused axis',
    axisLineDefocusedColor: 'the color of the line shown along the defocused axis',
    ...
    gridLineColor: 'the color of the axis grid lines',
    gridLineFocusedColor: 'the color of the focused axis grid lines',
    gridLineDefocusedColor: 'the color of the defocused axis grid lines',
    ...
    thresholdTitleFillColor: 'the fill color to use for the threshold title text',
    thresholdTitleFocusedFillColor: 'the fill color to use for the focused threshold title text',
    thresholdTitleDefocusedFillColor: 'the fill color to use for the defocused threshold title text',
    thresholdTitleStrokeOpacity: 'the stroke opacity (0 - 1) of the threshold title text',
    thresholdTitleStrokeFocusedOpacity: 'the stroke opacity (0 - 1) of the focused threshold title text',
    thresholdTitleStrokeDefocusedOpacity: 'the stroke opacity (0 - 1) of the defocused threshold title text',
    thresholdTitleFillOpacity: 'the fill opacity (0 - 1) of the threshold title text',
    thresholdTitleFillFocusedOpacity: 'the fill opacity (0 - 1) of the focused threshold title text',
    thresholdTitleFillDefocusedOpacity: 'the fill opacity (0 - 1) of the defocused threshold title text',
    ...
    thresholdColor: 'the color of the threshold line',
    thresholdFocusedColor: 'the color of the focused threshold line',
    thresholdDefocusedColor: 'the color of the defocused threshold line',
    ...
    tickLabelFillColor: 'the fill color to use for the axis tick labels text',
    tickLabelFocusedFillColor: 'the fill color to use for the focused axis tick labels text',
    tickLabelDefocusedFillColor: 'the fill color to use for the defocused axis tick labels text',
    ...
    tickMarkColor: 'the color of the axis tick mark lines',
    tickMarkFocusedColor: 'the color of the focused axis tick mark lines',
    tickMarkDefocusedColor: 'the color of the defocused axis tick mark lines',
    ...
    titleFillColor: 'the fill color of the axis title text',
    titleFocusedFillColor: 'the fill color of the focused axis title text',
    titleDefocusedFillColor: 'the fill color of the defocused axis title text',
