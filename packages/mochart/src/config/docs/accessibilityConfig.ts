export default function getDescriptions() {
  return {
    ...
    targetMinSize: 'the minimum size (in pixels) of the click targets the chart lays out itself',
