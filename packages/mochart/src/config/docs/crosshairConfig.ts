export default function getDescriptions() {
  return {
    ...
    lineColor: 'the color to use when showing the crosshair lines (use "currentColor" to follow the host page\'s css color and theme)',
    lineOpacity: 'the opacity (0 - 1) of the crosshair lines',
