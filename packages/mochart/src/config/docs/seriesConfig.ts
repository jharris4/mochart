...
export default function getDescriptions() {
  return {
    ...
    gradient: 'the unique id of the gradient config used to fill an area or bar series (use null for none; cannot be combined with pattern or colorProperty)',
    pattern: 'the unique id of the pattern config used to fill an area or bar series (use null for none; cannot be combined with gradient)',
