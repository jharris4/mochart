...
export default function getDescriptions() {
  return {
    ...
    labelMinRangeFraction: 'hide the label of any value whose shape spans less than this fraction (0 - 1) of the axis domain (use null for none)',
    labelOffset: 'the series position offset (in pixels) to apply to all series label positions',
    labelPosition: 'where to place the series labels relative to the value end of the series shape (inside, center, outside)',
    ...
    labelBelowBaseOffset: 'the series position offset (in pixels) to apply to all series label positions that are below the base value (use "auto" for the negated labelOffset)',
    labelAboveBasePosition: 'the labelPosition (inside, center, outside) applied only to series values above the base value (use "auto" to inherit labelPosition)',
    labelBelowBasePosition: 'the labelPosition (inside, center, outside) applied only to series values below the base value (use "auto" to inherit labelPosition)',
