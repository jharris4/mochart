...
Head to [Getting started](/guide/getting-started) for the full example, or
explore the interactive demo galleries: every binding has a full demo app —
[Vanilla TypeScript](/vanilla/), [Angular](/angular/), [Lit](/lit/),
[React](/react/), [Svelte](/svelte/), and [Vue](/vue/) — where you can edit
configs and data as JSON and export charts as SVG/PNG.
